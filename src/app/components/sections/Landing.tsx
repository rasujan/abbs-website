        ...
        <div>
          ...
          <Center>
            <Container bg="#ffffff55">
              ...
              <Text mb="md" fz="xl">
                Unleashing the full potential of your distinct advantages
                through our solutions: we are dedicated to ensuring your
                software is precise, smooth, vibrant, punctual, and within
                budget.{' '}
              </Text>
            </Container>
          </Center>
